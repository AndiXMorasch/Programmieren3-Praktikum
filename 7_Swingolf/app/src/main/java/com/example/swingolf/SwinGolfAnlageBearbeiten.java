...
public class SwinGolfAnlageBearbeiten extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_swing_golf_anlage_bearbeiten);
        ...
        Button buttonNeueSwinGolfAnlageAnlegen = findViewById(R.id.neueSwinGolfanlageAnlegen);
        buttonNeueSwinGolfAnlageAnlegen.setOnClickListener(view -> openActivityNeueSwinGolfAnlageAnlegen());

        Button deleteButton = findViewById(R.id.swinGolfanlagenLoeschen);
        deleteButton.setOnClickListener(view -> {
            try {
                loescheAusgewaehleAnlagen();
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
        });
    ...
    public void openActivityNeueSwinGolfAnlageAnlegen() {
        Intent intent = new Intent(this, SwinGolfAnlageAnlegen.class);
        startActivity(intent);
    }
    ...
    public void anlagenDarstellen(Context context) throws IOException {
    ...
    public void loescheAusgewaehleAnlagen() throws IOException {
        if(myCheckBoxes.isEmpty()) {
            Toast.makeText(this, "Es gibt nichts zum löschen!", Toast.LENGTH_LONG).show();
            return;
        }

        ArrayList<CheckBox> spielerCheckboxenUpdated = new ArrayList<>();
        ...
        while((currentLine = reader.readLine()) != null) {
            ...
            spielerCheckboxenUpdated.add(myCheckBoxes.get(zaehler));
        ...
        this.myCheckBoxes = spielerCheckboxenUpdated;
    ...
    // TODO: Hier noch prüfen wie man den Text zentrieren könnte (Programmatisch)
    @SuppressLint("SetTextI18n")
    void keineEintraegeVorhandenTextausgabe(Context context) {
        TextView textView = new TextView(context);
        textView.setText("Sie haben noch keine Anlagen angelegt!");
